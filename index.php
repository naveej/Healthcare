...
<body>
    <header class="header" id="header">
        ...
        <div class="header__title">
            <h1>
                Leading the way in <span class="highlight">Compassionate</span> and innovative <span class="highlight">healthcare</span>
    ...
    <div class="modal hidden">
        ...
        <form class="modal__form" id="registrationForm">
            ...
            <input class="show__password" type="checkbox" />
    ...
    <div class="modal-login hidden">
        ...
        <form class="modal__form" id="loginForm">
            ...
            <label>Password</label>
            <input name="password" class="login__password" type="password" />
            <label for="showPassword">Show Password</label>
